...
{
    public partial class MyULibraryBackendEntitiesMyULibraryDbContext_InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreName = table.Column<string>(type: "nvarchar(200)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Author = table.Column<string>(type: "nvarchar(150)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdBookLog = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdBook = table.Column<long>(type: "bigint", nullable: false),
                    IdUser = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLogs", x => x.IdBookLog);
                    table.ForeignKey(
                        name: "FK_BookLogs_Books_IdBook",
                        column: x => x.IdBook,
                        principalTable: "Books",
                        principalColumn: "IdBook",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLogs_Users_IdUser",
                        column: x => x.IdUser,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLogs_IdBook",
                table: "BookLogs",
                column: "IdBook");

            migrationBuilder.CreateIndex(
                name: "IX_BookLogs_IdUser",
                table: "BookLogs",
                column: "IdUser");
